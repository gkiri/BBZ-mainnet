...
const contractAddress = urlParams.get('contractAddress') || '0x8EDEeC3DaB0e3249909B3E70C0dE84Ca268987ef';
  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col items-center mt-6">
            <img src={BADBOYZ} alt="BadBoyz" className="responsive-image" style={{ marginTop: '6rem' }}/>
        </div>

        <div className="flex items-center justify-center w-full h-full col-span-1 lg:col-span-7 " >
          <div className="flex flex-col gap-4 p-6 lg:border rounded-xl lg:border-gray-800 mint-box2 mt-[-16.5rem] " >
            <div className="flex w-full gap-4 rounded-xl ">
              {dropNotReady ? (
                ...
                <div className="flex flex-col w-full gap-2 ">
                  <div className="flex flex-col w-full gap-2 lg:gap-2 lg:flex-row lg:items-center ">
                    <div>
